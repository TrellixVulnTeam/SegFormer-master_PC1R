...
class MLP_Mixer(nn.Module):
    def __init__(self, image_size, patch_size, token_dim, channel_dim, num_classes, dim, num_blocks):
        ...
        self.channel_dim = channel_dim
        n_patches =(self.image_size//patch_size) **2
        ...
        self.blocks = nn.ModuleList([
            Mixer_struc(patches=n_patches, token_dim=token_dim,channel_dim=self.channel_dim,dim=dim) for i in range(num_blocks)
        ])
